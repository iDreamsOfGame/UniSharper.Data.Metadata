...
namespace UniSharper.Data.Metadata.Samples
{
	...
	public partial class SampleMetadata : MetadataEntity
	{
		...
		/// Test Enum
		/// </summary>
		public int TestEnumIntValue { get; set; }

		/// <summary>
		/// Test Enum
		/// </summary>
		public TestEnumEnum TestEnum => (TestEnumEnum)TestEnumIntValue;

		/// <summary>
		/// Test Enum 2
		/// </summary>
		public int TestEnum2IntValue { get; set; }

		/// <summary>
		/// Test Enum 2
		/// </summary>
		public TestEnum2Enum TestEnum2 => (TestEnum2Enum)TestEnum2IntValue;

		/// <summary>
		/// 测试booleanArray
		/// </summary>
		public bool[] TestBooleanArray { get; set; }
		...
		/// 测试sbyteArray
		/// </summary>
		public sbyte[] TestSByteArray { get; set; }

		/// <summary>
		/// 测试shortArray
		/// </summary>
		public short[] TestShortArray { get; set; }

		/// <summary>
		/// 测试ushortArray
		/// </summary>
		public ushort[] TestUShortArray { get; set; }
		...
		/// 测试uintArray
		/// </summary>
		public uint[] TestUIntArray { get; set; }
		...
		/// 测试floatArray
		/// </summary>
		public float[] TestFloatArray { get; set; }

		/// <summary>
		/// 测试doubleArray
		/// </summary>
		public double[] TestDoubleArray { get; set; }

		/// <summary>
		/// 测试decimalArray
		/// </summary>
		public decimal[] TestDecimalArray { get; set; }
